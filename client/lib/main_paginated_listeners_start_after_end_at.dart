...
class MyApp extends StatelessWidget {
  final MessagesWithPaginatedListenersStartAfterEndAtStrategy _messages;
  MyApp()
      : _messages = MessagesWithPaginatedListenersStartAfterEndAtStrategy(
            MessagesRepository());
  @override
...
class MessageList extends StatelessWidget {
  static Provider inController(
      MessagesWithPaginatedListenersStartAfterEndAtStrategy messages) {
...
class MessagesWithPaginatedListenersStartAfterEndAtStrategy {
  ...
  MessagesWithPaginatedListenersStartAfterEndAtStrategy(this._repository) {
    _initialize();
  }
...
class MessagesRepository {
  Future<Stream<List<DataChange<Message>>>> changes(int limitNumber,
    ...
    final sentAt = _timestampToDateTime(qs.documents.last.data['sentAt']);

    return query.endAt([sentAt]).snapshots().map((qs) {
          querySnapshotDebugPrint(qs, 'result of listen with endAt');
